...
CREATE TABLE IF NOT EXISTS `product` (
  ...
  `special_price` DECIMAL(10,4) NOT NULL DEFAULT 0 COMMENT 'Prduct special price',
  `description` TEXT NULL COMMENT 'Product description',
  `created` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Created date',
  `modified` TIMESTAMP NULL COMMENT 'Last modified date',
  `deleted` TIMESTAMP NULL COMMENT 'Deteled date',
